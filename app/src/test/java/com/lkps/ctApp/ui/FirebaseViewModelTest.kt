...
import com.lkps.ctApp.util.LiveDataTestUtil.getValue
import com.lkps.ctApp.util.any
import com.lkps.ctApp.util.mock
import com.lkps.ctApp.util.nullable
import com.lkps.ctApp.util.unlockThread
...
class FirebaseViewModelTest {
    ...
    fun pushPicture() {
        ...
        sharedViewModel.pushFile(pictureUri)
        verify(chatRoomLiveData).pushFile(any(), any())
    }
}