...
import com.lkps.ct.databinding.DialogPhotoBinding
import com.lkps.ctApp.utils.bindImage
...
class PhotoDialog() : DialogFragment() {
    ...
    override fun onCreateView(
        ...
        if (savedInstanceState != null && savedInstanceState.containsKey(DRAWABLE_KEY)) {
            fileUrl = savedInstanceState.getString(DRAWABLE_KEY)!!
        }
        bindImage(binding.imageView, fileUrl)
    ...
    override fun onSaveInstanceState(outState: Bundle) {
        outState.putString(DRAWABLE_KEY, fileUrl)
