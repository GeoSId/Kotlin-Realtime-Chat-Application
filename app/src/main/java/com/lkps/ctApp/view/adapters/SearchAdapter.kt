...
import com.lkps.ct.databinding.ItemSearchBinding
import com.lkps.ctApp.data.model.User

class SearchAdapter(private val clickListener: OnSearchClickListener) : ListAdapter<User,
    ...
    class MsgViewHolder constructor(val binding: ItemSearchBinding) :
        ...
        fun bind(clickListener: OnSearchClickListener, item: User) {
            binding.user = item
    ...
    class OnSearchClickListener(val clickListener: (productId: User) -> Unit) {
