...
import com.lkps.ct.BR
import com.lkps.ct.databinding.*
import com.lkps.ctApp.data.model.Message
import com.lkps.ctApp.utils.Utility.savePdfTo
import com.lkps.ctApp.utils.Utility.savePicTo
...
class MsgAdapter(
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        return when (viewType) {
            ...
            R.layout.item_message_right_pdf -> ItemMessageRightPdfBinding.inflate(
                LayoutInflater.from(parent.context), parent, false
            )
            R.layout.item_message_left_pdf -> ItemMessageLeftPdfBinding.inflate(
                LayoutInflater.from(parent.context), parent, false
            )
    ...
    override fun getItemViewType(position: Int): Int {
        ...
        return if (item.isOwner == true) {
            when {
                item.audioUrl != null -> R.layout.item_message_right_record
                item.fileExtension.equals("jpg") ->{
                    R.layout.item_message_right_img }
                item.fileExtension.equals("pdf") -> R.layout.item_message_right_pdf
            ...
            when {
                ...
                item.fileExtension.equals("jpg") -> {
                    savePicTo(item)
                    R.layout.item_message_left_img}
                item.fileExtension.equals("pdf") -> {
                    savePdfTo(item)
                    R.layout.item_message_left_pdf}
    ...
    interface MsgAdapterListener {
        ...
        fun showPdf(view: View, message: Message)
   }
}